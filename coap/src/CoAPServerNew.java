...
public class CoAPServerNew {
    ...
    public static void main(String[] args) {
        ...
        // new resource for testing sending 500KB file
        server.add(new CoapResource("test") {
            ...
            public void handleGET(CoapExchange exchange) {
                ...
                System.out.println("Received GET request on resource test from client: " + clientIP);
                    
                // FileReadingExample reader = new FileReadingExample();
                String data = "";
                try {
                    data = ForFile.readFileAsString("C:\\Users\\Monk\\Desktop\\IoT_CoAP_implemention-main\\coap\\data\\1M.txt");
                } catch (IOException e) {
                    e.printStackTrace();
                }
                exchange.respond(data);

                System.out.println("Response Sent to client: " + clientIP + " ,*test*");
            }
        });
